                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell">
                                client<?php echo e($i); ?><em class="text-muted">@example.com</em>
                            </td>
                            <td>
                                <em class="text-muted"><?php echo e(rand(2, 10)); ?> days ago</em>
                            </td>
                        </tr>
                        <?php endfor; ?>
                    </tbody>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\Apps\resources\views/pages/datatables.blade.php ENDPATH**/ ?>