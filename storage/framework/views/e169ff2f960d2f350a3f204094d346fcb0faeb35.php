...
<body>
	...
	<header class="header-section">
		<div class="container">
			<!-- logo -->
			<a href="Accueil.html" class="site-logo"><img src="<?php echo e(asset('template/img/ministere.png')); ?>" alt=""></a>
			...
			<div class="hs-item set-bg" data-setbg="<?php echo e(asset('template/img/hero-slider/Capture1.png')); ?>">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								<div class="hs-subtitle">Direction de la Formation Professionnelle et Technique</div>
								...
								<div class="btn btn-info text-white"><a href="/aboutus">Qui sommes nous?</a></div>
							</div>
						</div>
					</div>
				</div>
			</div>
			<div class="hs-item set-bg" data-setbg="<?php echo e(asset('template/img/hero-slider/fatoush.jpg')); ?>">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
...
</html><?php /**PATH C:\wamp\www\GestionProgramme\resources\views/pages/acceuil.blade.php ENDPATH**/ ?>