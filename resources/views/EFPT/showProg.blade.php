            ...
            <tbody>
               ...
               <tr>
                ...
                {{ $prog->anne_aca }}
                  ...
                  <td>
                     <a href="{{ route('prog.info',[$prog->programme->id ,$prog->etablissement_id,$eta->departement_id,$eta->departement->region_id,$prog->niveau_id,$prog->anne_aca]) }}" class="btn text-white" style="background-color:rgb(246, 120, 58);">Voir</a>
                  </td>
               </tr>
               @endforeach
               @endforeach
